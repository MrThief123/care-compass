...
export function EnterEventLink({ clientId }: EnterEventLinkProps) {
  return (
    <Link
      ...
      className="inline-flex h-13 w-full items-center justify-center rounded-control bg-primary text-body-emphasis text-primary-foreground transition-colors outline-none hover:bg-primary/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring focus-visible:ring-[3px] focus-visible:ring-ring/50"
    >
      Enter event
    </Link>
  );
