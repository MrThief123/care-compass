...
| Feature branch | `feature/admin-ui-home` |
| Documentation | `docs/development/admin-dev/admin-ui-home/` |
| Lane | A — Admin |
| Sprint | SPRINT · planned D4 |
| Status / owner | See PROGRESS.md |

## Purpose
Deliver the Admin · Home UI on fixtures.
...
- Sources: Design: Admin · Home; UI-D5
