...
| Feature branch | `feature/admin-ui-settings` |
| Documentation | `docs/development/admin-dev/admin-ui-settings/` |
| Lane | A — Admin |
| Sprint | SPRINT · planned D6 |
| Status / owner | See PROGRESS.md |

## Purpose
Deliver the Admin · Settings UI on fixtures.
...
- Non-blocking open decisions (proposed defaults apply, confirm when possible): OQ-35
