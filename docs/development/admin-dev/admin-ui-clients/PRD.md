...
| Feature branch | `feature/admin-ui-clients` |
| Documentation | `docs/development/admin-dev/admin-ui-clients/` |
| Lane | A — Admin |
| Sprint | SPRINT · planned D6 |
| Status / owner | See PROGRESS.md |

## Purpose
Deliver the Admin · Clients UI on fixtures.
...
- Non-blocking open decisions (proposed defaults apply, confirm when possible): OQ-06, OQ-07
...
- Sources: Design: Admin · Clients; UI-D28, §7.16
