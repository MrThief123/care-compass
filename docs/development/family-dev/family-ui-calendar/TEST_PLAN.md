...
| T-09 | AC-09 | component + e2e | Added by CHG-017. The toolbar's "Enter event" link: href `/family/<id>/events/new?from=calendar&view=…&date=…&month=…` in week, day and month views, follows a picked day, sits before the D/W/M control, 44px tall (`family-calendar.test.tsx`). e2e: from the month view, Enter event then Cancel returns to that month view; no overflow at 1920–768 (`family-calendar.spec.ts`). | ☑ | PASS |
