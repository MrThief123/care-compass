...
| Feature branch | `feature/family-ui-calendar` |
| Documentation | `docs/development/family-dev/family-ui-calendar/` |
| Lane | F — Family |
| Sprint | SPRINT · planned D4–D5 |
| Status / owner | See PROGRESS.md |

## Purpose
Deliver the Family · Calendar UI on fixtures.
...
- Sources: Design: Family · Calendar; UI-D6, D12, D26, D27
