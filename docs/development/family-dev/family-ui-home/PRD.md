...
| Feature branch | `feature/family-ui-home` |
| Documentation | `docs/development/family-dev/family-ui-home/` |
| Lane | F — Family |
| Sprint | SPRINT · planned D4 |
| Status / owner | See PROGRESS.md |

## Purpose
Deliver the Family · Home UI on fixtures.
...
- Non-blocking open decisions (proposed defaults apply, confirm when possible): OQ-29, OQ-24
...
- Sources: Design: Family · Home; UI-§7.1; UI-D14, D17, D21, D25, D27, D33, D35
