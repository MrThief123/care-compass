...
Exact next action: on the human's "yes", push and open PR "FAM-UI-03 Family Add / Edit event screens (UI)" to `family-dev` with the side-by-side screenshot (mention CHG-009 / PR #78 in the body), then set Status to PR OPEN.
