...
Worked on: CHG-020 tests (`fecb598`) and build (`997ef7b`); then, after the human's review of the inline form, CHG-021 recorded (PD-059, FD-12): 'Edit' opens an Edit budget page; buckets are open (add, rename, remove)
...
Current blocker: None. CHG-021 docs written and waiting for the human's review before any test changes.
...
Exact next action: after the human reviews the CHG-021 docs, rewrite T-04 to T-06 and write T-09 to T-12 failing first (replacing the CHG-020 inline-form tests, FD-12), run them red, commit `test(family): …`. Do not open the PR before the human's "yes".
