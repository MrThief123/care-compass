...
Exact next action: on the human's "yes", push the branch and open the PR to `family-dev`, titled `FAM-UI-05 Family Budget screen (UI)`. Body flags: see PROGRESS.md "Ready for PR". Do not open it before the "yes".
