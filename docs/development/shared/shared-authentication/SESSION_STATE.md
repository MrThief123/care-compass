...
Current branch: `feature/shared-authentication` (claimed from `main`)
...
Exact next action: Human reviews and, if satisfied, approves opening the PR `feature/shared-authentication` → `main`. After merge, F0-08, F0-10, ADM-02, FAM-12, CAR-09, ADM-10 unblock.
