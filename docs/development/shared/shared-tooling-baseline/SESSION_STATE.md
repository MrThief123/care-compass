...
Exact next action: PR opened to `main` (human-approved 2026-09-17). After merge: create `family-dev`, `carer-dev`, `admin-dev` from `main` and confirm T-04/AC-04.
Files likely to be touched next: none for this feature until post-merge branch creation
Warning for next session: AC-04 cannot be verified until this branch is merged to `main`.
