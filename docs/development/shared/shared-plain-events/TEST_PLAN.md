...
| T-15 | AC-10 | component | Switch: role, `aria-checked`, accessible name, 44px class, "On"/"Off"; click, Space and Enter toggle; controlled value respected. | ☑ | PASS (`src/components/shared/forms/plain-events.test.tsx`) |
