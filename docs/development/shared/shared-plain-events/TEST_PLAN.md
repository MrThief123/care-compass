...
| T-17 | AC-12 | axe | Calendar, lists and forms axe files gain plain-event and switch fixtures; zero violations. | ☐ | NOT RUN |
| T-18 | AC-12 | unit | No raw colour values in the changed kit files (token classes only). | ☐ | NOT RUN |
