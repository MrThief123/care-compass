...
Current blocker: none; FD-02 awaits the human. FD-01 ANSWERED: Option A (no `type` = tasks only); log and export callers pass `type: "all"`.
...
Important decisions: FD-01 (answered, Option A), FD-02 (pending).
