...
Worked on: FD-07 hydration fix in `event-popover.tsx` (approved); Task 5 (lists kit); before that Task 4 (calendar kit, solid stripe per CHG-010).
...
Important decisions: FD-01, FD-02, FD-03 (answered), FD-04, FD-05, FD-06 (implementation notes), FD-07 (approved bug fix); CHG-010 (root DECISIONS.md, confirmed by the human).
