...
| Feature branch | `feature/carer-ui-settings` |
| Documentation | `docs/development/carer-dev/carer-ui-settings/` |
| Lane | C — Carer |
| Sprint | SPRINT · planned D6 |
| Status / owner | See PROGRESS.md |

## Purpose
Deliver the Carer · Settings UI on fixtures.
...
- Non-blocking open decisions (proposed defaults apply, confirm when possible): OQ-35, OQ-13
