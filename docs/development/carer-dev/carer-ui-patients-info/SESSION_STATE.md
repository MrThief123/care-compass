...
Worked on: implementation until green, full suite, e2e, browser check
...
Test results: feature 34/34 green; full vitest 1861 passed, 5 F0-04/F0-07 integration failures (`Invalid API key`, environment); e2e 36/36
Current blocker: none
Important decisions: FD-04 amended (reuse `CarerHomeErrorState`); FD-05 (fixtures test change, test typing, streamed notFound, OQ-09 default)
Exact next action:
