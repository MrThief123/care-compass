...
CHG-031 (2026-09-26, after implementation) merged the calendar into Carer Home: AC-03 (default view Day, was Week), AC-06 (URLs `/carer/home?…`, was `/carer/calendar?…`; Next day added), AC-09 (the loading skeleton is Carer Home's, tested by CAR-UI-01 AC-09) and AC-10 (loading covered by CAR-UI-01 AC-10) changed. See DECISIONS.md FD-04.
...
| AC-03 | US-01 | happy | Given Carer Home with no view param, when rendered, then D is selected, the 'Shifts' heading shows, and only today is read (30 Nov); given `?view=week`, W is selected and the week of today is read (30 Nov – 6 Dec). | MET |
| AC-04 | US-01 | happy | Given a shift block in Week or Day, when it is clicked, then the app goes to `/carer/patients/<clientId>` (Margaret's patient page). | MET |
...
| AC-06 | US-01 | happy | Given the week of 30 Nov, when Next week, Previous week, Today or M is pressed, then the URL becomes `/carer/home?view=week&date=2026-12-07`, `…date=2026-11-23`, `…date=2026-11-30`, and `…view=month&date=2026-11-30&month=2026-12` respectively; given today's Day view, Next day gives `/carer/home?view=day&date=2026-12-01`. | MET |
...
| AC-11 | US-01 | happy | Given today is on screen in Day or Week, with or without shifts, then the red current-time line is drawn at the current Melbourne time on today's column only (added at the human's request, 2026-09-26, FD-06). | MET |
