...
| T-11 | AC-11 | component | Clock pinned to another real day: Week draws the line only in today's column; Day draws it with no shifts; no line when today is off screen. | ☑ | PASS |
