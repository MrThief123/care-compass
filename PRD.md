...
| REQ-07 | Access | Admins add and remove clients for their organisation. Admins can edit client information like Family (REQ-38; supersedes UI-D28, CHG-020). | SHOULD · CONFIRMED (PD-058) | UI-D28, §7.16; Design Clients; Human, 2026-09-25 (PD-058) | ADM-04, ADM-11 |
...
| REQ-27 | Budget | Each funding bucket shows $ remaining, $ total and % used individually; buckets in trouble are flagged. A client has the buckets someone added, each with its own name (NDIS, Fixed, Government are suggestions), possibly none. | MUST · CONFIRMED (PD-033 as amended by PD-059) | UI-D7, D17; US P-6, C-12; Design Home/Budget; Human, 2026-09-25 (PD-059) | UI-03, F0-12, FAM-03, FAM-10, FAM-UI-05 |
| REQ-28 | Budget | Spending automatically deducts from the relevant bucket; remaining = total − spending. Care is never blocked by money: an event cost the bucket cannot cover is held as pending and flagged (REQ-37). | MUST · CONFIRMED (pending model PD-058) | CM-0409; CIS3 Data 5; CIS5 Q&A; UC-F01; Human, 2026-09-25 (PD-058) | F0-12, FAM-03, FAM-10 |
| REQ-29 | Budget | Funds and buckets are changed only on the Edit budget page (opened by 'Edit' on the Budget screen), by Family and the client's organisation admins: add or remove funds, add, rename or remove a bucket, with one optional note and a dated history. Carers never change funds by hand. A removal cannot take a bucket below $0; a bucket with spending or pending costs cannot be removed. Each History entry opens to its details (note, recorder, paid or pending), and History can be exported as CSV (PD-060). | MUST · CONFIRMED (PD-034, PD-058, PD-059, PD-060) | UI-D1, D19; CM-0409; Design Budget; Human, 2026-09-25 (PD-058, PD-059) | F0-12, FAM-UI-05, FAM-10, FAM-11, ADM-11 |
| REQ-30 | Budget | Care-related spending is recorded as an event's cost (REQ-37) or as a Family/admin removal (REQ-29). Separate carer expense entry and receipts are retired (CHG-020). | SHOULD · CONFIRMED (PD-058) | BRIEF V; CM-0309; US C-11; UC-C06; Sequence UC2; Human, 2026-09-25 (PD-058) | FAM-11, FAM-UI-08 |
...
| REQ-37 | Budget | An event or task may have an optional cost and the bucket it is paid from, set by whoever creates it (carers included) and changeable afterwards by Family, admins or the carer who created it, for future completions only. The cost is charged once per completed occurrence; skipped or missed occurrences cost nothing. A cost the bucket cannot cover in full is held as pending (whole, never part-paid), shown on the Budget screen and emailed to Family and admins; pending costs are paid automatically, oldest first, when funds are added, stopping at the first one the balance cannot cover (PD-060); pending costs are listed in their own section on the Budget screen. The event form strikes through a bucket at $0 or with pending costs and warns when the balance is below the cost. | MUST · CONFIRMED | Human, 2026-09-25 (PD-058, CHG-020; PD-060, CHG-022) | F0-11, F0-12, FAM-UI-05, FAM-UI-08, FAM-06, FAM-07, FAM-15, CAR-06, CAR-07, FAM-11, INT-01 |
| REQ-38 | Access | An admin can do everything Family can for their own organisation's clients, except change the client's organisation (Family only). Clicking a client in Admin · Clients opens that client's Family screens inside the admin layout. Every change records who made it. | MUST · CONFIRMED | Human, 2026-09-25 (PD-058, CHG-020) | ADM-11, F0-12 |
...
| Edit client info | Yes | Only during active shift (OQ-09) | Yes, own-org clients (PD-058) |
| Create/edit events | Yes | During active shift (OQ-09) | Yes, own-org clients (PD-058) |
| Mark Done | Yes (D26) | During active shift | Yes, own-org clients (PD-058) |
| Switch an event between task and plain event | Yes | During active shift, either way (CHG-009) | Yes, own-org clients (PD-058) |
| View budget | Yes | UNKNOWN | Yes, own-org clients (PD-058) |
| Add or remove funds | Yes (PD-034, PD-058) | No | Yes, own-org clients (PD-034, PD-058) |
| Set an event's cost and bucket | Yes | When creating an event; afterwards only on events they created (PD-058) | Yes, own-org clients (PD-058) |
...
| PL-10 | Funding source restrictions, multiple accounting periods, inter-bucket transfers, categories/sub-elements (named funding sources as buckets moved into scope by PD-059) | BRIEF IV, item 5; CIS5; FR-6.1–6.4 | Descoped CM-0309; OQ-04; PD-059 |
