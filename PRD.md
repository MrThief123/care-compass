...
| REQ-29 | Budget | Funds are added or removed only on the Budget screen, by Family and the client's organisation admins, with one form (bucket, add or remove, amount, optional note) and a dated history. Carers never change funds by hand. A removal cannot take a bucket below $0. | MUST · CONFIRMED (PD-034, PD-058) | UI-D1, D19; CM-0409; Design Budget; Human, 2026-09-25 (PD-058) | F0-12, FAM-UI-05, FAM-10, FAM-11, ADM-11 |
