...
| REQ-38 | Access | An admin can do everything Family can for their own organisation's clients. Clicking a client in Admin · Clients opens that client's Family screens inside the admin layout. Every change records who made it. | MUST · CONFIRMED | Human, 2026-09-25 (PD-058, CHG-020) | ADM-11, F0-12 |
